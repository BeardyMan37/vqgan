...
class Encoder(nn.Module):
    def __init__(self, *, ch, out_ch, ch_mult=(1,2,4,8), num_res_blocks,
        ...
        def conv4x4_bn_relu(in_channels, out_channels):
        ...
        self.fc_struct = torch.nn.Linear(in_features=256,
                                         out_features=40)
        self.conv_downsample = torch.nn.Conv1d(in_channels=z_channels,
                                               out_channels=1,
                                               kernel_size=1)
